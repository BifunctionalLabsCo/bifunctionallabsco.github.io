...
3. Make it standalone:
   ...
   - Inject Google Fonts `@import` so the SVG renders with correct typography in a browser:
     ```svg
     <defs>
       <style>@import url('https://fonts.googleapis.com/css2?family=Fraunces:ital,opsz,wght@0,9..144,300;0,9..144,400;0,9..144,500;0,9..144,600;1,9..144,500&family=Montserrat:wght@400;500;600&display=swap');</style>
     </defs>
     ```
