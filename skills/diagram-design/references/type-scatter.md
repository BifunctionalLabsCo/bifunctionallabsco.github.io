...
- **Trend line (optional):** `<line>` from lower-left to upper-right, stroke `rgba(3,43,34,0.25)` dashed 4,3. Never force a perfect fit — only add if the trend is visually obvious.
...
<circle cx="X" cy="Y" r="5" fill="#efede7"/>
<circle cx="X" cy="Y" r="5" fill="rgba(0,99,77,0.20)" stroke="#00634d" stroke-width="1"/>

<!-- Focal point -->
<circle cx="X" cy="Y" r="6" fill="#efede7"/>
<circle cx="X" cy="Y" r="6" fill="rgba(255,79,129,0.15)" stroke="#ff4f81" stroke-width="1.2"/>
```
