...
- **Axis labels:** one word per spoke (Jobs-minimal). Montserrat sans 11px weight 600. Place 16px outside the outer ring along the axis vector. Top/bottom = `text-anchor="middle"`; right side = `start`; left side = `end`.
...
<polygon points="500,96 622,201 585,356 415,356 363,196"
         fill="rgba(255,79,129,0.18)" stroke="#ff4f81" stroke-width="1.8"/>
```
...
- **Mono-font axis labels.** Names go in Montserrat sans (the global rule). Mono is for technical sublabels only.
