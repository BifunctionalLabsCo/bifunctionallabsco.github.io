...
- Each row contains (left→right):
  ...
  2. **Layer name** slightly right of center-left — Montserrat 14–16px 600.
  3. **Sublabel / note** on the far right — system mono 9–10px muted.
- Border between layers: 1px hairline `rgba(3,43,34,0.12)`. Outer silhouette 1px ink or muted.
