...
```svg
<!-- 1. Italic Fraunces text -->
<text x="904" y="36" fill="#032b22" font-size="14" font-style="italic"
      font-family="'Fraunces', serif" text-anchor="end">no imports, no configuration</text>
<!-- 2. Dashed Bézier leader -->
<path d="M 820 44 Q 700 84 520 216" fill="none"
      stroke="rgba(3,43,34,0.40)" stroke-width="1" stroke-dasharray="4,3"/>
<!-- 3. Landing dot -->
<circle cx="520" cy="216" r="2" fill="#032b22"/>
```
...
| Intent | Text | Leader |
|---|---|---|
| Neutral aside | ink `#032b22` | `rgba(3,43,34,0.40)` |
| Focal / accent | accent `#ff4f81` | `rgba(255,79,129,0.50)` |
| Tertiary (muted) | muted `#00634d` | `rgba(3,43,34,0.30)` |
