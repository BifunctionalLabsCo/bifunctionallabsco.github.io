...
<marker id="arrow-open" markerWidth="8" markerHeight="6" refX="7" refY="3" orient="auto">
  <polyline points="0 0, 8 3, 0 6" fill="none" stroke="#00634d" stroke-width="1.2"/>
</marker>
```

Dark mode: stroke `#9eb3aa` (muted on dark paper). Do not fill the open marker — the hollow head is the async signal. Return messages keep the **filled** marker even when dashed.
...
<rect x="X" y="Y" width="W" height="H" rx="4"
      fill="rgba(3,43,34,0.02)" stroke="rgba(3,43,34,0.22)" stroke-width="1"/>
<!-- Operator tab -->
<rect x="X" y="Y" width="40" height="16" rx="2"
      fill="#efede7" stroke="rgba(3,43,34,0.22)" stroke-width="1"/>
<text x="X+20" y="Y+12" fill="#00634d" font-size="8"
      font-family="'system mono', monospace" text-anchor="middle"
      letter-spacing="0.12em">ALT</text>
```

Dark mode: frame fill `rgba(239,237,231,0.04)`, stroke `rgba(239,237,231,0.22)`, tab fill = dark `paper` (`#032b22`), tab text = dark `muted` (`#9eb3aa`).
...
<text x="X+12" y="GUARD_Y" fill="#00634d" font-size="8"
      font-family="'system mono', monospace" letter-spacing="0.04em">[token valid]</text>

<!-- alt region divider -->
<line x1="X+8" y1="DIV_Y" x2="X+W-8" y2="DIV_Y"
      stroke="rgba(3,43,34,0.20)" stroke-width="1" stroke-dasharray="4,3"/>
```
...
<line x1="CX" y1="TOP" x2="CX" y2="BOTTOM"
      stroke="rgba(3,43,34,0.20)" stroke-width="1" stroke-dasharray="3,3"/>
```

## Activation bar primitive
```svg
<rect x="CX-4" y="TOP" width="8" height="H"
      fill="rgba(3,43,34,0.06)" stroke="#00634d" stroke-width="0.8"/>
```
...
- Fragment operator label in Montserrat sans — must be mono: `ALT` / `OPT` / `LOOP`.
